...
export const BentoGridItem = ({
  ...
  const handleCopy = () => {
    const text = "network.sbasak@gmail.com";
  ...
  return (
    <div
      ...
      style={{
        background: 'linear-gradient(90deg, rgba(25, 0, 36, 1) 0%, rgba(50, 6, 99, 1) 35%, rgba(0, 212, 255, 1) 100%)',
      }}
    >
      ...
      <div className={`${id === 6 && "flex justify-center"} h-full`}>
        ...
        <div
            className={`absolute right-0 -bottom-5 ${[4, 5].includes(id) ? "w-full opacity-80" : ""}`}
        >
          {spareImg && (
            <img
              src={spareImg}
